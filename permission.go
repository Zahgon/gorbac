...
func NewPermission[T comparable](id T) Permission[T] { _ = "STUB: not implemented"; return nil }
...
func (p StdPermission[T]) Match(a Permission[T]) bool { _ = "STUB: not implemented"; return false }
